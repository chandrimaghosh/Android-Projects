 ...
 */
public class ScraggleTwoPlayerGameFragment extends android.app.Fragment {

     ArrayList<String> file = new ArrayList<>();
    private Handler mHandler = new Handler();
    private String nineWords[] = {"", "", "", "", "", "", "", "", ""};
    private ScraggleTwoPlayerTile mEntireBoard = new ScraggleTwoPlayerTile(this);
    private ScraggleTwoPlayerTile mLargeTiles[] = new ScraggleTwoPlayerTile[9];
    private ScraggleTwoPlayerTile mSmallTiles[][] = new ScraggleTwoPlayerTile[9][9];
    ...
    private boolean isTwoPlayerFirst = false;
    ...
    public ScraggleTwoPlayerGameFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (two.equalsIgnoreCase("twoPlayer")) {
            isTwoPlayer = true;
        }
        if (two.equalsIgnoreCase("twoPlayerFirstMove")) {
            isTwoPlayerFirst = true;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_scraggle_two_player_game, container, false);
        ...
        mDatabase.addChildEventListener(
                new ChildEventListener() {
                    ...
                    public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                        ...
                        String gamedata = user.getGameData();


                        if (dataSnapshot.getKey().equalsIgnoreCase(player1id)) {
                            isTwoPlayer = true;
                            if (!(gamedata.equalsIgnoreCase("")||gamedata==null)) {
                                putState(user.getGameData());
                                initViews(rootView);
                            }
    ...
    public void initGame() {
        ...
        mEntireBoard = new ScraggleTwoPlayerTile(this);
        // Create all the tiles
        for (int large = 0; large < 9; large++) {
            mLargeTiles[large] = new ScraggleTwoPlayerTile(this);
            for (int small = 0; small < 9; small++) {
                mSmallTiles[large][small] = new ScraggleTwoPlayerTile(this);
            }
    ...
    private void initViews(View rootView) {
        String[] words=
                {"dummydummy","dummydummy","dummydummy","dummydummy","dummydummy","dummydummy","dummydummy","dummydummy","dummydummy"};;
        if (isTwoPlayer)
        {
        ...
        for (int large = 0; large < 9; large++) {
            ...
            for (int small = 0; small < 9; small++) {
                ...
                final ScraggleTwoPlayerTile smallTile = mSmallTiles[large][small];
                            ...
                            if (CheckWord(smallTile.getInnerText(), smallTile.getLargePosition())) {
                                if( !(detectRepeatWords( smallTile.getLargePosition())))
                                {
                                    ...
                                    {sum=calculateScoreForPhaseOne(smallTile.getLargePosition());
                                        ((TwoPlayerCommunicationActivity) getActivity()).setScore(sum);
                                        ((TwoPlayerCommunicationActivity) getActivity()).mScoreTextField.setText("Score =" + Integer.toString(sum));
                                        if(isNetworkAvailable()) {
                                            mDatabase.child(player1id).child("gameData").setValue(getState());
                                            mDatabase.child(player1id).child("totalScore").setValue(sum);
                                        }
                                        else
                                    ...
                                    {sum2=calculateScoreForPhaseTwo(smallTile.getLargePosition());
                                        ...
                                        ((TwoPlayerCommunicationActivity) getActivity()).setScore2(sum2);

                                        ((TwoPlayerCommunicationActivity) getActivity()).mScoreTextField.setText("Score =" + Integer.toString(sum2));
                                    }


                                    mSoundPool.play(mSoundRewind, mVolume, mVolume, 1, 0, 1f);
                                    String word=nineWords[smallTile.getLargePosition()];
                                    ((TwoPlayerCommunicationActivity) getActivity()).mWordTextField.setText(word);
    ...
    private boolean switchedBlock(ScraggleTwoPlayerTile tile,int lastsmall,int lastlarge)
    {
    ...
    private  boolean isValidMove(ScraggleTwoPlayerTile tile,int lastsmall,int lastlarge) {
    ...
    public String getState() {
        ...
        builder.append(((TwoPlayerCommunicationActivity) this.getActivity()).getSavedRemainingInterval());
        builder.append(',');
        builder.append(((TwoPlayerCommunicationActivity) this.getActivity()).getScore());
        builder.append(',');
        builder.append(((TwoPlayerCommunicationActivity) this.getActivity()).getScore2());
        builder.append(',');
        builder.append(((TwoPlayerCommunicationActivity) this.getActivity()).isPhaseTwo());
        builder.append(',');
    ...
    public void putState(String gameData) {
        try {
            ...
            ((TwoPlayerCommunicationActivity) this.getActivity()).setSavedRemainingInterval(savedInterval);
            sum = Integer.parseInt(fields[index++]);
            ((TwoPlayerCommunicationActivity) this.getActivity()).setScore(sum);
            sum2 = Integer.parseInt(fields[index++]);
            ((TwoPlayerCommunicationActivity) this.getActivity()).setScore2(sum2);

            isPhaseTwo = Boolean.parseBoolean(fields[index++]);
            ((TwoPlayerCommunicationActivity) this.getActivity()).setPhaseTwo(isPhaseTwo);
